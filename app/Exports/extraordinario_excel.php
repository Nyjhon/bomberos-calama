...
class extraordinario_excel implements 
    FromQuery, 
    WithEvents,
    WithCustomStartCell,
    WithMapping,
    ...
    WithTitle
{
    ...
    public function fecha($fecha_ext){
    ...
    {
        return extraordinario::query()->where('fecha_ext', $this->fecha_ext);
    }
    ...
    public function headings(): array
    {
        return [
            ...
            ['GESTION '.Carbon::parse($this->fecha_ext)->year],
            ['','','PARTE DIARIO DE LA FECHA: '.Carbon::parse($this->fecha_ext)->day.' DE '.getMesArrayKey(Carbon::parse($this->fecha_ext)->month).' DE ' .Carbon::parse($this->fecha_ext)->year],
            [
            'FORM. 08 A  COD. NUM.',
            'GESTION',
            'HORA DEL HECHO',
    ...
    {
        return Carbon::parse($this->fecha_ext)->format('d-m-Y');
    }
}
